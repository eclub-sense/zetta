...
var PeerClient = module.exports = function(url, server) {
  ...
  //console.log(server.httpServer.zetta._username, server.httpServer.zetta._password);

  var _username = server.httpServer.zetta._username;
  var _password = server.httpServer.zetta._password;
  var _uuid     = server.httpServer.zetta._uuid;

  this.ws = new WebSocket(this._createNewUrl(), {}, _username, _password, _uuid);
